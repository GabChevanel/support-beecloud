...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-yellow-50/50 py-1 pr-3 pl-1.5 text-sm text-yellow-900 ring-1 ring-yellow-500/20 ring-inset dark:bg-yellow-500/5 dark:text-yellow-200 dark:ring-yellow-500/30">
